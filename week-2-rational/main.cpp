...
/// \brief
/// a definition for compatibility with MinGW
/// \details
/// This definition is needed for Catch to work with MinGW.
#define TWOBLUECUBES_CATCH_REPORTER_JUNIT_HPP_INCLUDED

/// \brief
/// a namespace belonging to Catch
/// \details
/// a name space is made with the name 'Catch'. This namespcae contains a class JunitReporter.
/// This JunitReporter class can generate JUnit xml output when using test_case with multiple sections. 
